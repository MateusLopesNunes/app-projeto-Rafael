...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\mateus.nunes\Documents\vs code\procute_aqui\myenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\mateus.nunes\Documents\vs code\procute_aqui\myenv\Scripts\deactivate.nu'
